...
const Custom404 = () => {
    return (
        <div className="flex flex-col items-center justify-center bg-white gap-4 h-screen">
            <div>
                <Image src="/static/esimaintKC.png" alt="Image" width={250} height={250} className="rounded-full" />
            </div>
            <div className="text-center">
                <h1 className="text-9xl sm:text-11xl font-bold text-[darkBlue] mb-6">404</h1>
                <h2 className="font-heading text-4xl sm:text-5xl font-bold text-[darkBlue] mb-6">
                ...
                <Link
                    ...
                    href="/"
                    style={{ backgroundColor: "#F97316", marginTop: "-30px" }}
                >
                    <div
