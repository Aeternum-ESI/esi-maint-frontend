...
export function CalendarWrapper({ assets, categories }: { assets: Asset[]; categories: Category[] }) {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <Card className="lg:col-span-1">
                ...
                <CardContent>
                    <Calendar selectedDate={selectedDate} onSelectDate={setSelectedDate} minDate={new Date()} />
